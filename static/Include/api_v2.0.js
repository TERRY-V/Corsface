window.BMAP_AUTHENTIC_KEY = "hlrOyIkzhSAYj7LpG4izpFZo1qrYd5Gm"; (function() {
    function aa(a) {
        throw a;
    }
    function getcPath(){
    ...
    x.lang.Ba.prototype.dispatchEvent = function(a, b) {
        x.lang.ug(a) && (a = new x.lang.Zy(a)); ! this.Ii && (this.Ii = {});
        var b = b || {},
        c;
        for (c in b) a[c] = b[c];
        var d = this.Ii,
    ...
    x.extend(Ka.prototype, {
        ...
        Bg: function(a) {
            if (this.Hb !== a) {
                ...
                b.Ka = c;
                b.Hb = a;
                this.dispatchEvent(b); (a === Xa || a === Ra) && Pa(xa)
            }
        },
        Vf: function(a) {
            var b = this;
        ...
        Zs: function(a, b) {
            ...
            for (var b = b || {},
            e = [], f = 0, g = d.length; f < g; f++) e.push(this.we.Jm(d[f], this.Vb));
            d = new fb;
        ...
        var l = {
            send: function(a) {
                ...
                function(d, e) {
                    ...
                    c.push('{"t":{' + f.join(",") + '},"a":' + e.UU + "}"); ! g && (a && e.start) && (g = e.start)
                }), b(k,
                function(a, b) {
                    e.push(a + "=" + b)
    ...
    x.object.extend(I, {
            ...
            if (d.Bd == this.Fj.Zp) c && b();
                ...
                if (d.Bd == this.Fj.nG) {
                    ...
                    e.DC == q && (e.DC = o, setTimeout(function() {
                        ...
                        e.DC = q;
                        e.Nd.En.length = 0;
                        0 == a.length ? e.UK() : Qb(e.gG.VP,false) //+ "&mod=" + a.join(","))
                    },
                    1));
                    d.Bd = this.Fj.EP;
                   // console.log(e.gG.VP + "&mod=" + a.join(","));
                }
                d.Pu.push(b)
            }
        },
        jK: function(a) {
            if (a && this.nL()[a]) for (var a = this.nL()[a], b = 0; b < a.length; b++) this.jK(a[b]),
        ...
        hb: function(a) {
            ...
            this.Nd.rl[a].Bd = this.Fj.nG, this.Nd.rl[a].Pu = []);
            return this.Nd.rl[a]
        },
        remove: function(a) {
            delete this.hb(a)
        ...
        sV: function(a, b) {
            ...
            d = o,
            e = 0,
            f = c.length; e < f; e++)"" == c[e].KE && (c[e].MM == a ? c[e].KE = b: d = q);
            d && this.UK()
        },
        UK: function() {
            for (var a = this.Nd.Pv,
            b = 0,
            c = a.length; b < c; b++) this.yZ(a[b].MM, a[b].KE);
            this.Nd.Pv.length = 0
        }
    });
    function Q(a, b) {
    ...
    function ib(a, b) {
        a && (this.Kb = a, this.ba = "spot" + ib.ba++, b = b || {},
        this.Vg = b.text || "", this.wv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.rJ = b.userData || p, this.Qh = b.minZoom || p, this.Cf = b.maxZoom || p)
    }
    ib.ba = 0;
    ...
    x.extend(Sb.prototype, {
        ...
        Ce: function(a) { ! this.B && (this.initialize && Wa(this.initialize)) && (this.B = this.initialize(a));
            this.k = this.k || {
                Ag: q
            };
            this.wB();
    ...
    function pc(a, b, c, d) {
        a && (this.Bv = {},
        this.$K = d ? !!d: q, this.Vc = [], this.v_ = a instanceof oc ? a: p, this.EI = b === j ? o: !!(b.indexOf("%") + 1), this.$j = isNaN(parseFloat(b)) ? 1 : this.EI ? parseFloat(b) / 100 : parseFloat(b), this.FI = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.FI ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    function qc(a, b) {
        x.lang.Ba.call(this);
        this.content = a;
    ...
    x.extend(qc.prototype, {
        ...
        PN: function(a) { ! a && 0 != a || (isNaN(a) || 0 > a) || (0 != a && (220 > a && (a = 220), 730 < a && (a = 730)), this.z.maxWidth = a)
        },
        Dc: function(a) {
            this.z.title = a
        },
    ...
    function wc(a, b) {
        var c = this;
        vc() && (a === j && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {},
        gb.apply(c, arguments), c.da = {
            ia: a
        },
        c.z = {
            shape: b.shape || tc,
        ...
        this.gB = [], this.ke = [], I.load("pointcollection",
        function() {
            for (var a = 0,
    ...
    x.extend(Dc.prototype, {
        ...
        k_: function(a, b, c, d) {
            ...
            k && k.Gb ? (wb(k.Gb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.te ? this.map.K.te.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Gc(k, d)), k.loaded ? this.vf() : Hc(k,
            function() {
                e.vf()
            })) : (k = this.fj[g]) && k.Gb ? (c.Pb.insertBefore(k.Gb, c.Pb.lastChild), this.wg[g] = k, wb(k.Gb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.te ? this.map.K.te.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Gc(k, d)), k.loaded ? this.vf() : Hc(k,
            function() {
                e.vf()
            })) : (k = i * Math.pow(2, f.qm() - a[2]), new H(a[0] * k, a[1] * k), d = new Q(a[0], a[1]), f = this.map.K.te ? this.map.K.te.style: "normal", d = c.getTilesUrl(d, a[2], f), k = new Ic(this, d, b, a, c), Hc(k,
            function() {
                e.vf()
            }), k.$n(), this.wg[g] = k)
        },
        ...
        Tf: function(a) {
            var b = this;
            if (b.map.oa() == Oa) I.load("coordtrans",
            function() {
        ...
        lI: function(a) {
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.ZH && !(i.mp && !this.map.Ub() || i.iM && this.map.Ub())) {
                    ...
                    for (A in C) {
                        var B = C[A],
                        D = B.info; (D[2] != f || D[2] == f && (n > D[0] || v <= D[0] || l > D[1] || e <= D[1])) && this.Ex(B)
                    }
                    ...
                    w = [];
                    for (d.LB = []; n < v; n++) for (y = l; y < e; y++) w.push([n, y]),
                    d.LB.push({
                        x: n,
                        y: y
                    });
        ...
        Nt: function(a) {
            var b = this.map.oa();
            if (!this.map.Ub() && (a ? this.map.K.s_ = a: a = this.map.K.s_, a)) for (var c = p,
            c = "2" == z.ou ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++) if (e.f_ == o) {
                b.k.Zb = 18;
    ...
    Vc.getTilesUrl = function(a, b, c) {
        ...
        var cL=getcPath()+"/bMap/maptile/" + b + "/" + d + "/" + a + ".jpg";
    ...
    x.extend(bc.prototype, {
        ca: function() {
            ...
            function() {
                c.Sg(bc.$k + "qt=idata&iid=" + b.qA + "&fn=",
                function(b) {
    ...
    x.extend(Yd, {
        ...
        uL: function(a, b, c, d, e) {
            ...
            return (Yd.Du + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
            function(a, b) {
                return f[b]
            })
        }
    ...
    Ce = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
    function(a) {
    ...
    function Fe(a, b) {
        ...
        c.refresh();
        c.ca(we, window);
        c.ca(xe); ! te && "none" != c.options.SO && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
    ...
    Fe.prototype = {
        ...
        pQ: function() { ! this.rh && (!this.Wk && !(this.Vl || this.vy == this.Nb.offsetWidth * this.scale && this.Fp == this.Nb.offsetHeight * this.scale)) && this.refresh()
        },
        Ev: function(a) {
            var b;
        ...
        AQ: function(a) {
            if (a.wR === o) return this.NB = a.target,
            this.ax = Date.now(),
            o;
            if (this.NB && this.ax) {
                if (600 < Date.now() - this.ax) return this.ax = this.NB = p,
                o
            } else {
            ...
            if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.lZ = o,
            a.stopPropagation(),
            a.preventDefault(),
            this.ax = this.NB = p,
            q
        ...
        Nv: function(a) {
            ...
            d;
            if (this.enabled) {
                this.options.WM && this.options.WM.call(this, a); (this.options.Bi || this.options.zoom) && this.nJ(0);
                ...
                if (this.options.Ux && (this.options.Uk ? (c = getComputedStyle(this.Nb, p)[ie].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Bi ? this.Vd(Be) : De(this.VB),
                this.Aj = [],
                this.xr(d, c),
        ...
        ZS: function(a) {
            ...
            if (this.options.zoom && te && 1 < a.touches.length) e = $d.abs(a.touches[0].pageX - a.touches[1].pageX),
            ...
            if (! (te && 0 !== a.touches.length)) {
                ...
                b.options.up && b.options.up.call(b, a);
                    ...
                    if (b.rh) {
                        ...
                        if (te) if (b.EK && b.options.zoom) clearTimeout(b.EK),
                        b.EK = p,
        ...
        io: function(a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.rh && (this.rh = q, this.options.$x && this.options.$x.call(this)), this.mi && this.options.Dx && ("webkit" == be && (this.LL.style[pe] = "300ms"), this.LL.style.opacity = "0"), this.Ci && this.options.Dx)"webkit" == be && (this.KO.style[pe] = "300ms"),
        ...
        EU: function(a) {
            ...
            if ("zoom" == b.options.SO) {
                if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Vk && (d = b.options.Vk), d > b.options.Xp && (d = b.options.Xp), d != b.scale) ! b.Qy && b.options.vp && b.options.vp.call(b, a),
                b.Qy++,
                b.zoom(a.pageX, a.pageY, d, 400),
                setTimeout(function() {
                    b.Qy--; ! b.Qy && b.options.up && b.options.up.call(b, a)
                },
                400)
            } else c = b.x + c,
            d = b.y + d,
    ...
    x.extend(Ge.prototype, {
        ...
        ny: function(a, b) {
            if (b || !this.bk[this.Yc] || !(this.bk[this.Yc].panoId == a && 3 !== this.bk[this.Yc].recoType)) {
                var c = this,
                d = this.BH(a); ! b && -1 !== d && this.bk[d] && 3 !== this.bk[d].recoType ? this.Jp(d) : this.xX(function(a) {
                    for (var b = {},
                    d, i, k = q,
                    l = [], m = 0, n = a.length; m < n; m++) d = a[m].catlog,
                    i = a[m].floor,
                    j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Ie[d]] || (b[Ie[d]] = []), b[Ie[d]].push(a[m])));
